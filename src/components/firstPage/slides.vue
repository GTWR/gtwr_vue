<template>
  <div style="width:100%;height:100%" class="slides">
    <div class="slides_container" v-show="slideShow[0]">
      <div class="slides_container_top">
        <div class="slides_container_top_img"><img :src="slidesContent[0].imgSrc" class="slides_container_top_img_img"></div>
        <div class="slides_container_top_chartContainertop">
          <div id="chart0" class="slides_container_top_chartContainertop_chart"></div>
          <div id="chart1" class="slides_container_top_chartContainertop_chart"></div>
        </div>
      </div>
      <div class="slides_container_bottom">
        <div class="slides_container_bottom_left">
          <div class="slides_container_bottom_left_paper"><img :src="slidesContent[0].paperSrc" class="slides_container_bottom_left_paper_img"></div>
          <div class="slides_container_bottom_left_abstract">{{slidesContent[0].abstract.slice(0,800)}}...</div>
        </div>
        <div class="slides_container_bottom_chart" id="chart2"></div> 
      </div>
    </div>

    <div class="slides_container" v-show="slideShow[1]">
      <div class="slides_container_top">
        <div class="slides_container_top_img"><img :src="slidesContent[1].imgSrc" class="slides_container_top_img_img"></div>
        <div class="slides_container_top_chartContainertop">
          <div id="chart3" class="slides_container_top_chartContainertop_chart"></div>
          <div id="chart4" class="slides_container_top_chartContainertop_chart"></div>
        </div>
      </div>
      <div class="slides_container_bottom">
        <div class="slides_container_bottom_left">
          <div class="slides_container_bottom_left_paper"><img :src="slidesContent[1].paperSrc" class="slides_container_bottom_left_paper_img"></div>
          <div class="slides_container_bottom_left_abstract">{{slidesContent[1].abstract.slice(0,800)}}...</div>
        </div>
        <div class="slides_container_bottom_chart" id="chart5"></div> 
      </div>
    </div>

    <div class="slides_container" v-show="slideShow[2]">
      <div class="slides_container_top">
        <div class="slides_container_top_img"><img :src="slidesContent[2].imgSrc" class="slides_container_top_img_img"></div>
        <div class="slides_container_top_chartContainertop">
          <div id="chart6" class="slides_container_top_chartContainertop_chart"></div>
          <div id="chart7" class="slides_container_top_chartContainertop_chart"></div>
        </div>
      </div>
      <div class="slides_container_bottom">
        <div class="slides_container_bottom_left">
          <div class="slides_container_bottom_left_paper"><img :src="slidesContent[2].paperSrc" class="slides_container_bottom_left_paper_img"></div>
          <div class="slides_container_bottom_left_abstract">{{slidesContent[2].abstract.slice(0,800)}}...</div>
        </div>
        <div class="slides_container_bottom_chart" id="chart8"></div> 
      </div>
    </div>

    <div class="slides_container" v-show="slideShow[3]">
      <div class="slides_container_top">
        <div class="slides_container_top_img"><img :src="slidesContent[3].imgSrc" class="slides_container_top_img_img"></div>
        <div class="slides_container_top_chartContainertop">
          <div id="chart9" class="slides_container_top_chartContainertop_chart"></div>
          <div id="chart10" class="slides_container_top_chartContainertop_chart"></div>
        </div>
      </div>
      <div class="slides_container_bottom">
        <div class="slides_container_bottom_left">
          <div class="slides_container_bottom_left_paper"><img :src="slidesContent[3].paperSrc" class="slides_container_bottom_left_paper_img"></div>
          <div class="slides_container_bottom_left_abstract">{{slidesContent[3].abstract.slice(0,800)}}...</div>
        </div>
        <div class="slides_container_bottom_chart" id="chart11"></div> 
      </div>
    </div>
    <div class="playBtn">
