...
* 工作内容：
	* 实现按钮点击高亮
	* 在“精度评定”页面中利用真实的计算结果，基本上将目前页面上的图表修正为正确的能够真实展现计算精度评估的图表，并在文字描述部分描述对应的计算精度。

----------------------------------------------
## 项目任务安排

<p style="color:red">!!!!截止时间：2018年6月9日 10:00</p>
...
* 凌志鹏：
	* 实现页面所有按钮的高亮
	* 在“精度评定”页面中利用真实的计算结果，将目前页面上的图表修正为正确的能够真实展现计算精度评估的图表，并在文字描述部分描述对应的计算精度；这一部分的数据可以咨询李晨悦
